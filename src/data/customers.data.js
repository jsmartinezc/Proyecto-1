...
exports.deleteCustomerByAccountNumber =
  exports.updateCustomer =
  exports.createCustomer =
  exports.readCustomerByName =
  exports.readCustomerById =
  exports.readCustomers =
    void 0;
...
var readCustomerById = function (id) {
  return new Promise(function (resolve, reject) {
    try {
      var result = localCustomersDB.filter(function (item) {
        return item.id === id;
      });
      resolve(result);
    } catch (error) {
...
var updateCustomer = function (id, body) {
  return new Promise(function (resolve, reject) {
    try {
      var customerIndex = localCustomersDB.findIndex(function (item) {
        return item.id === id;
      });
      if (customerIndex === -1) {
        reject(404);
